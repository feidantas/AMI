...
targ = '2~62'	# A75 : Target Field
pcal = '63'	# 3C286 : Primary Calibrator
...
if gain1:
	...
	if not os.path.exists(caltab):
		print "No G0 gain solution found, exiting"
		stop
...
if delay:
	...
	if not os.path.exists(caltab):
		print "No delay solution found, exiting"
		stop
...
if bndps:
	...
	if not os.path.exists(caltab):
		print "No bandpass solution found, exiting"
		stop
...
if gain2:
	...
	if not os.path.exists(caltab):
		print "No G1 gain solution found, exiting"
		stop
